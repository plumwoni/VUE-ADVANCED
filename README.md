...
#### CLI로 생성한 프로젝트 배포
 ...
 2. Netlify 사이트를 이용한 배포
   1) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_01.png" width=300 height=300 align=center>
   2) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_02.png" width=300 height=300 align=center>
   3) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_03.png" width=300 height=300 align=center>
   4) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_04.png" width=300 height=300 align=center>
   5) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_05.png" width=300 height=300 align=center>
   6) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_06.png" width=300 height=300 align=center>
   7) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_07.png" width=300 height=300 align=center>
   8) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_08.png" width=300 height=300 align=center>
   9) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_09.png" width=300 height=300 align=center>
   10) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_10.png" width=300 height=300 align=center>
   11) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_11.png" width=300 height=300 align=center>
   12) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_12.png" width=300 height=300 align=center>
   13) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_13.png" width=300 height=300 align=center>
   14) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_14.png" width=300 height=300 align=center>
   15) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_15.png" width=300 height=300 align=center>
   16) <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_16.png" width=300 height=300 align=center>
 ...
 4. SPA 호스팅 시에 서버에 추가해줘야 하는 설정 적용 및 자동 배포
    ...
    4) 확인
        <img src="https://github.com/plumwoni/VUE-ADVANCED/blob/main/readMe용_참조파일/netlify_17.png" width=300 height=300>
#### Tips
 ...
 - 컴포넌트 등록은 파스칼방식으로 등록하면, vscode에서는 template에서 케팝형식으로 타입핑하면 태그가 자동으로 완성됨
  (Vue 공식사이트에서는 템플릿에서 파스칼 방식으로 사용하는 걸 권장)
...
#### 개발환경
Node.js 공식 사이트 주소 : [링크](https://nodejs.org/ko/)
Gist 주소 (깃헙 리포지토리 권한 요청 페이지) : [링크](https://gist.github.com/joshua1988/062448fd0251fa928d71276b3ba2f1eb)
Vue.js 실전 강좌 비공개 리포지토리 주소 : [링크](https://github.com/joshua1988/vue-advanced)
...
- 팀 개발을 위한 Git, GitHub 시작하기 : [링크](http://www.yes24.com/Product/Goods/85382769?Acode=101)
- 초심자를 위한 Github 협업 튜토리얼 : [링크](https://milooy.wordpress.com/2017/06/21/working-together-with-github-tutorial/)
...
#### 스타일 가이드 링크
[링크](https://vuejs.org/v2/style-guide/)
...
#### life-cycle hook function
 ...
 - [링크](https://vuejs.org/v2/guide/reactivity.html#ad)  참조
...
#### ES6
 ...
 - `axios.get()` 등의 리턴 값은 **Promise** 객체이며 해당 객체는 파이프로 then, catch 함수를 붙여 사용할 수 있음
 - 화살표 함수 ( => )
    ```
    예>
      var vm = this;
...
#### Promise 객체
 ...
 - 자바스크립트 Promise 쉽게 이해하기 : [링크](https://joshua1988.github.io/web-development/javascript/promise-for-beginners/)
 - Promise MDN 주소 : [링크](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Promise)
...
<img src="http://vuejs.org/images/data.png" alt="Reactivity Cycle" width=600 valign=center>
...
#### Mixins(믹스인)
 ...
 - 믹스인에 정의할 수 있는 재사용 로직은 `data`, `methods`, `created` **등**과 같은 컴포넌트 옵션입니다.
...
#### vue.js에서 외부라이브러리 모듈화 방법
 ...
 2. chart.js 모듈화
    1) 새로운 프로젝트 생성
        > (프로젝트 루트로 이동 -> vue create chart-lib -> default로 설치)
    2) 설치 확인
        > (cd chart-lib -> npm run serve -> 브라우저 확인) 및 파일들 초기화 (@/components/Hello~ 파일 삭제, @/App.vue 초기화)
    3) chart.js 설치 - 공식문서 참조
 ...
 3. 차트를 컴포넌트화
    ...
    2) `2.chart.js 모듈화`의 5)에서 붙여넣었던 `mounted()` 라이프사이클 훅 부분을 그대로 복붙
 ...
 6. 컴포넌트 통신을 이용한 차트 컴포넌트 기능 결합
    1) 컴포넌트 구성시 되도록이면 하위 컴포넌트는 단순 기능을 하는 컴포넌트여야 함
